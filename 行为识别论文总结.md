...
* ###IJCAI
	...
	2. Deep Convolutional Neural Networks On Multichannel Time Series or Human Activity Recognition
    深度神经网络在行为识别中的应用

	3. Acivity Recognition with Finite State Machines 
    有限状态机理论在行为识别中。。。不太懂

	4. Feature Learning for Activity Recognition in Ubiquitous Computing
    行为识别中的特征学习
